    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('color', models.CharField(max_length=7, unique=True, validators=[django.core.validators.RegexValidator(message="Цвет должен быть в формате '#RRGGBB'", regex='^#([A-Fa-f0-9]{6})$')], verbose_name='Цвет тега')),
